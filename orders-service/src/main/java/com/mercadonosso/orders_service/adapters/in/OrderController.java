...
public class OrderController {
    ...
    public DashboardResponse getDashboard(@PathVariable UUID sellerId,
        ...
        // Ordena produtos por quantidade vendida e pega os top
        ...
        for (DashboardResponse.TopProduct product : topProducts) {
    ...
    private List<Order> filterOrdersByPeriod(List<Order> orders, String period) {
        ...
        return orders.stream()
                .filter(order -> {
                    ...
                    if (order.getDate() instanceof LocalDateTime) {
                        return order.getDate().isAfter(cutoffDate);
                    }
    ...
    private LocalDateTime calculateCutoffDate(String period) {
        ...
        switch (period) {
            ...
            default:
                return now.minusDays(30); // Default para 30 dias
        }
    }
}